...
The `load_data` function takes in raw data and creates a data object that can be accepted by the `plot_sw_design` and `analyze_sw_data` functions. We use the made-up dataframe `sw_data_example` to demonstrate the workflow.
